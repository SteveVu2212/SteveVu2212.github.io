...
async function draw(){
    ...
    let periodSelected = d3.select("#periodSelection").property("value")
    ...
    const dot_excessReturn = bounds_excessReturn.append("g")
        .attr("display", "none");

    dot_excessReturn.append("circle")
        .attr("r", 2.5);
    ...
    // console.log(document.getElementById("userSelection").getBoundingClientRect())
